...
MOCK_RESPONSES = {
    ...
    "What was Machiavelli's legacy, why was he considered ruthless?": {
        "question": "What was Machiavelli's legacy, why was he considered ruthless?",
        "answer": "Niccolò Machiavelli's legacy is complex and somewhat paradoxical. He is best known for his work \"The Prince,\" which has become one of the most debated works of political philosophy globally. However, the term \"Machiavellian\" has come to signify traits such as ruthlessness, cunning, and manipulation, which only represents a facet of his ideas.\n\nMachiavelli earned the reputation of being ruthless because of his clear-eyed view of power that later informed his most famous works. He believed in realism, observation, and strategy rather than abstract ideals, a philosophy that was seen as notoriously practical and devoid of moral qualms. His experiences with kings, popes, and military leaders, where he saw firsthand how power outcome was influenced more by cunning, force, and ambition rather than idealism or morality, are considered factors contributing to this reputation.\n\nYet, the label \"Machiavellian\" oversimplifies his thought, since Machiavelli also had a deep admiration for republican government, the importance of citizen involvement, and the preservation of liberty. He did not advocate for cruelty for its own sake but offered guidance on how rulers could navigate the ruthless world of Renaissance politics.",
        "confidence": {
            "level": "High",
            "explanation": "The information is sourced directly from the document and answers the question comprehensively."
        },
        "sources": [
            {
                "file_name": "Niccolò Machiavelli - A Modern Minimal Biography.docx",
                "chunk_index": 0
            },
            {
                "file_name": "Niccolò Machiavelli - A Modern Minimal Biography.docx",
    ...
    "Describe Kendall's correlations for percieve leader integrity": {
        "question": "Describe Kendall's correlations for perceived leader integrity",
        "answer": "Kendall's correlations for perceived leader integrity are described in matrix forms across different employee attitudes towards diversity and varying levels of perceived ethical leadership, including High Ethical, Moderate Ethical, and Low Ethical instances.\n\nIn Table 4, the correlation results are as follows:\n\n| Attitude Toward Diversity | Perceived Leader Integrity | Kendall's τ (tau) | No. of Participants | p |\n|---------------------------|----------------------------|-------------------|---------------------|---|\n| Optimistic                | High Ethical               | -.10**            | 422                 | < .01 |\n|                           | Moderate Ethical           | .00               | 70                  | N/A |\n|                           | Low                        | -.12              | 15                  | N/A |\n| Realist                   | High Ethical               | -.02              | 188                 | N/A |\n|                           | Moderate Ethical           | -.04              | 185                 | N/A |\n|                           | Low                        | .03               | 13                  | N/A |\n| Pessimist                 | High Ethical               | -.26*             | 32                  | < .05 |\n|                           | Moderate Ethical           | .08               | 13                  | N/A |\n|                           | Low                        | -.99              | 3                   | N/A |\n\nIn Table 5, the correlation data was measured against five diversity dimensions: Emotional Reactions, Judgments, Behavioral Reactions, Personal Consequences, and Organizational Outcomes. A sample of the correlations is as follows:\n\n| Perceived Leader Integrity | No. of Participants | Emotional Reactions τ | Judgments τ | Behavioral Reactions τ | Personal Consequences τ | Organizational Outcomes τ |\n|----------------------------|---------------------|-----------------------|-------------|------------------------|-------------------------|---------------------------|\n| High Ethical               | 642                 | -.16**                | -.16**      | -.12**                 | -.17**                  | -.15**                    |\n| Moderate Ethical           | 268                 | .00                   | -.05        | -.08                   | -.06                    | .01                       |\n| Low                        | 31                  | -.17                  | -.12        | -.12                   | -.13                    | -.06                      |\n\n(** = p < .01)",
        "confidence": {
            "level": "High",
            "explanation": "Information taken directly from provided tables"
        },
        "sources": [
            {
                "file_name": "Kendall's Integrity Research Paper.docx",
                "chunk_index": 0
            },
            {
                "file_name": "Kendall's Integrity Research Paper.docx",
        ...
        "source_documents": [
            "Kendall's Integrity Research Paper.docx"
        ],
        "chunks_found": 3
    },
