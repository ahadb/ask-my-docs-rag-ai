...
export default function SignInPage({ onLogin, isAuthenticated }: SignInProps) {
              ...
              <form onSubmit={handleSignIn} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <a href="#" className="text-sm font-medium" style={{ color: '#D9664A' }} onMouseEnter={(e) => { e.currentTarget.style.color = '#D9664A'; }} onMouseLeave={(e) => { e.currentTarget.style.color = '#D9664A'; }}>Having trouble?</a>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full flex justify-center py-2 px-4 rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    style={{ 
                  ...
                  >
                    {isLoading ? (
                      <div className="flex items-center">
                        <div className="animate-spin rounded-full h-4 w-4 border-b-2 mr-2" style={{ borderColor: '#D9664A' }}></div>
                        Signing in...
                      </div>
                    ) : (
                      "Sign in"
